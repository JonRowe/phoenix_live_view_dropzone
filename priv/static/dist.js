...
$parcel$export(module.exports, "PhoenixLiveViewDropzone", () => $349a00930b14e029$export$a97b6dfc795a2c05);
$parcel$export(module.exports, "default", () => $349a00930b14e029$export$2e2bcd8739ae039);
var $ef9e05928b654e5b$exports = {};
(function(scope) {
...
*/ var _Scheduler_working = false;
    ...
    var $author$project$Uploads$empty = $elm$core$Dict$empty;
    ...
    var $author$project$Main$init = function(config) {
        var parseFrom = F3(function(field, _default, decoder) {
            var _v0 = A2($elm$json$Json$Decode$decodeValue, A2($elm$json$Json$Decode$field, field, decoder), config);
            if (_v0.$ === 'Ok') {
                var value = _v0.a;
                return value;
            } else return _default;
        });
        var parseTextFrom = F2(function(field, _default) {
            return A3(parseFrom, field, _default, $elm$json$Json$Decode$string);
        });
        var text = A2(parseTextFrom, 'text', '');
        var fileTypes = A3(parseFrom, 'fileTypes', _List_Nil, $elm$json$Json$Decode$list($elm$json$Json$Decode$string));
        var buttonText = A2(parseTextFrom, 'buttonText', 'Upload');
        var buttonClass = A2(parseTextFrom, 'buttonClass', '');
        return _Utils_Tuple2({
            ...
            hover: false,
            text: text,
            uploads: $author$project$Uploads$empty
        }, $elm$core$Platform$Cmd$none);
    };
    var $author$project$Main$UploadProgress = F2(function(a, b) {
        return {
            $: 'UploadProgress',
            a: a,
            b: b
    ...
    var $author$project$Main$UrlGenerated = function(a) {
        return {
            $: 'UrlGenerated',
            a: a
        };
    ...
    var $author$project$Ports$addUploadUrl = _Platform_incomingPort('addUploadUrl', A2($elm$json$Json$Decode$andThen, function(url) {
    ...
    var $elm$http$Http$track = F2(function(tracker, toMsg) {
        return $elm$http$Http$subscription(A2($elm$http$Http$MySub, tracker, toMsg));
    });
    ...
    var $author$project$Uploads$subscribe = F2(function(uploads, msg) {
        var subscription = function(upload) {
            return A2($elm$http$Http$track, upload.id, msg(upload));
        };
        return A2($elm$core$List$map, subscription, $elm$core$Dict$values(uploads));
    });
    var $author$project$Main$subscriptions = function(model) {
        var urlSub = $author$project$Ports$addUploadUrl($author$project$Main$UrlGenerated);
        return $elm$core$Platform$Sub$batch(_Utils_ap(_List_fromArray([
            urlSub
        ]), A2($author$project$Uploads$subscribe, model.uploads, $author$project$Main$UploadProgress)));
    };
    var $author$project$Upload$Done = {
        $: 'Done'
    };
    var $author$project$Upload$Error = {
        $: 'Error'
    };
    var $author$project$Main$FileSelected = F2(function(a, b) {
        return {
            $: 'FileSelected',
            a: a,
            b: b
    ...
    var $author$project$Main$StartUpload = function(a) {
        return {
            $: 'StartUpload',
            a: a
        };
    ...
    var $author$project$Upload$InProgress = {
        $: 'InProgress'
    };
    ...
    var $author$project$Upload$makeUpload = F2(function(file, id) {
        var size = $elm$file$File$size(file);
        ...
        return {
            ...
            sent: 0,
            size: size,
            status: $author$project$Upload$InProgress
        };
    });
    ...
    var $author$project$Upload$createUpload = F2(function(msg, file) {
        var setIdInUpload = A2($elm$core$Basics$composeL, $elm$core$Task$succeed, $author$project$Upload$makeUpload(file));
        var idFromTime = function(posix) {
            return $elm$core$String$fromInt($elm$time$Time$posixToMillis(posix));
        };
        var generateId = A2($elm$core$Basics$composeL, $elm$core$Task$succeed, idFromTime);
        return A2($elm$core$Task$perform, msg, A2($elm$core$Task$andThen, setIdInUpload, A2($elm$core$Task$andThen, generateId, $elm$time$Time$now)));
    });
    var $author$project$Uploads$delete = F2(function(uploads, id) {
        return A2($elm$core$Dict$remove, id, uploads);
    });
    ...
    var $author$project$Uploads$get = F2(function(uploads, id) {
        return A2($elm$core$Dict$get, id, uploads);
    });
    var $author$project$Upload$export = function(upload) {
        var status = function() {
            var _v0 = upload.status;
            switch(_v0.$){
                case 'InProgress':
                    return 'InProgress';
                case 'Done':
    ...
    var $author$project$Ports$uploadStatus = _Platform_outgoingPort('uploadStatus', function($) {
        return $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('body', function($) {
                return A3($elm$core$Maybe$destruct, $elm$json$Json$Encode$null, $elm$json$Json$Encode$string, $);
            }($.body)),
            _Utils_Tuple2('id', $elm$json$Json$Encode$string($.id)),
            _Utils_Tuple2('name', $elm$json$Json$Encode$string($.name)),
            _Utils_Tuple2('progress', $elm$json$Json$Encode$int($.progress)),
            _Utils_Tuple2('sent', $elm$json$Json$Encode$int($.sent)),
            _Utils_Tuple2('size', $elm$json$Json$Encode$int($.size)),
            _Utils_Tuple2('status', $elm$json$Json$Encode$string($.status))
        ]));
    });
    var $author$project$Ports$notifyUploadStatus = function(upload) {
        return $author$project$Ports$uploadStatus($author$project$Upload$export(upload));
    };
    var $author$project$Ports$requestUrl = _Platform_outgoingPort('requestUrl', function($) {
        return $elm$json$Json$Encode$object(_List_fromArray([
            _Utils_Tuple2('id', $elm$json$Json$Encode$string($.id)),
            _Utils_Tuple2('name', $elm$json$Json$Encode$string($.name))
        ]));
    });
    var $author$project$Main$Done = F2(function(a, b) {
        return {
            $: 'Done',
            a: a,
            b: b
    ...
    var $author$project$Main$startUpload = F2(function(upload, url) {
        var handleResponse = function(result) {
            if (result.$ === 'Ok') {
                var string = result.a;
                return A2($author$project$Main$Done, upload.id, string);
            } else return $author$project$Main$Error(upload.id);
        };
        return $elm$http$Http$request({
            body: $elm$http$Http$fileBody(upload.file),
            expect: $elm$http$Http$expectString(handleResponse),
            headers: _List_Nil,
            method: 'PUT',
            timeout: $elm$core$Maybe$Nothing,
            tracker: $elm$core$Maybe$Just(upload.id),
            url: url
        });
    });
    var $author$project$Uploads$update = F2(function(uploads, upload) {
        var setUpload = function(_v0) {
            return $elm$core$Maybe$Just(upload);
        };
        return A3($elm$core$Dict$update, upload.id, setUpload, uploads);
    });
    var $author$project$Upload$updateUploadProgress = F2(function(upload, progress) {
        if (progress.$ === 'Sending') {
            var data = progress.a;
            var percentage = $elm$core$Basics$ceiling(data.sent / upload.size * 100);
            return _Utils_update(upload, {
                progress: percentage,
                sent: data.sent
            });
        } else return upload;
    ...
    var $author$project$Main$update = F2(function(msg, model) {
        var setUpload = function(upload) {
            return _Utils_update(model, {
                uploads: A2($author$project$Uploads$update, model.uploads, upload)
            });
        };
        var notifyUploadStatus = F3(function(id, status, body) {
            var _v2 = A2($author$project$Uploads$get, model.uploads, id);
            if (_v2.$ === 'Just') {
                var upload = _v2.a;
                return $author$project$Ports$notifyUploadStatus(_Utils_update(upload, {
                    body: body,
                    status: status
                }));
            } else return $elm$core$Platform$Cmd$none;
        });
        var finishUpload = F3(function(id, status, maybeBody) {
            var newModel = _Utils_update(model, {
                uploads: A2($author$project$Uploads$delete, model.uploads, id)
            });
            return _Utils_Tuple2(newModel, A3(notifyUploadStatus, id, status, maybeBody));
        });
        switch(msg.$){
            case 'OpenFileSelect':
                return _Utils_Tuple2(model, A2($elm$file$File$Select$files, model.fileTypes, $author$project$Main$FileSelected));
            case 'SetHover':
                var hover = msg.a;
            ...
            case 'FileSelected':
                ...
                return _Utils_Tuple2(_Utils_update(model, {
                    hover: false
                }), $elm$core$Platform$Cmd$batch(A2($elm$core$List$map, $author$project$Upload$createUpload($author$project$Main$StartUpload), A2($elm$core$List$cons, file, files))));
            case 'StartUpload':
                var upload = msg.a;
                return _Utils_Tuple2(setUpload(upload), $author$project$Ports$requestUrl({
                    id: upload.id,
                    name: upload.name
                }));
            case 'UrlGenerated':
                var target = msg.a;
                var _v1 = A2($author$project$Uploads$get, model.uploads, target.id);
                if (_v1.$ === 'Just') {
                    var upload = _v1.a;
                    return _Utils_Tuple2(model, A2($author$project$Main$startUpload, upload, target.url));
                } else return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
            case 'UploadProgress':
                var upload = msg.a;
                var progress = msg.b;
                var updated = A2($author$project$Upload$updateUploadProgress, upload, progress);
                return _Utils_Tuple2(setUpload(updated), $author$project$Ports$notifyUploadStatus(updated));
            case 'Done':
                var uploadId = msg.a;
                var body = msg.b;
                return A3(finishUpload, uploadId, $author$project$Upload$Done, $elm$core$Maybe$Just(body));
            default:
                var uploadId = msg.a;
                return A3(finishUpload, uploadId, $author$project$Upload$Error, $elm$core$Maybe$Nothing);
        }
    });
    var $elm$json$Json$Decode$value = _Json_decodeValue;
    var $author$project$Main$OpenFileSelect = {
        $: 'OpenFileSelect'
    };
    var $author$project$Main$SetHover = function(a) {
        return {
            $: 'SetHover',
            a: a
        };
    ...
    var $author$project$Main$view = function(model) {
        ...
        var dragHandler = F2(function(event, decoder) {
            return A2($elm$html$Html$Events$preventDefaultOn, event, A2($elm$json$Json$Decode$map, preventDefault, decoder));
        });
        var decodeDrop = A2($elm$json$Json$Decode$at, _List_fromArray([
            'dataTransfer',
            'files'
        ]), A2($elm$json$Json$Decode$oneOrMore, $author$project$Main$FileSelected, $elm$file$File$decoder));
        return A2($elm$html$Html$div, _List_fromArray([
            model.hover ? $elm$html$Html$Attributes$class('drag-hovering') : $elm$html$Html$Attributes$class(''),
            A2(dragHandler, 'dragenter', $elm$json$Json$Decode$succeed($author$project$Main$SetHover(true))),
            A2(dragHandler, 'dragover', $elm$json$Json$Decode$succeed($author$project$Main$SetHover(true))),
            A2(dragHandler, 'dragleave', $elm$json$Json$Decode$succeed($author$project$Main$SetHover(false))),
            A2(dragHandler, 'drop', decodeDrop)
        ]), _List_fromArray([
            $elm$html$Html$text(model.text),
            A2($elm$html$Html$button, _List_fromArray([
                $elm$html$Html$Attributes$class(model.buttonClass),
                $elm$html$Html$Events$onClick($author$project$Main$OpenFileSelect),
                $elm$html$Html$Attributes$type_('button')
            ]), _List_fromArray([
                $elm$html$Html$text(model.buttonText)
            ]))
        ]));
    };
...
})($ef9e05928b654e5b$exports);


'use strict';
const $349a00930b14e029$var$eventName = "phx-dropzone";
const $349a00930b14e029$export$a97b6dfc795a2c05 = {
    mounted () {
        ...
        pushEvent = (event)=>{
            ...
            if (target) liveView.pushEventTo(target, $349a00930b14e029$var$eventName, event);
            else liveView.pushEvent($349a00930b14e029$var$eventName, event);
        };
        generateUrl = (data)=>pushEvent([
                "generate-url",
                data
            ])
        ;
        statusUpdate = (data)=>pushEvent([
                "file-status",
                data
            ])
        ;
        ...
        if (this.el.dataset.buttonClass) flags.buttonClass = this.el.dataset.buttonClass;
        if (this.el.dataset.buttonText) flags.buttonText = this.el.dataset.buttonText;
        if (this.el.dataset.fileTypes) flags.fileTypes = this.el.dataset.fileTypes.split(",");
        if (this.el.dataset.text) flags.text = this.el.dataset.text;
        this.app = $ef9e05928b654e5b$exports.Elm.Main.init({
            flags: flags,
            node: node
        });
    ...
    updated () {
        ...
        if (dataset && this.dataId !== dataset.id && this.dataUrl !== dataset.url) {
            ...
            this.app.ports.addUploadUrl.send({
                id: this.dataId,
                url: this.dataUrl
            });
        }
...
var $349a00930b14e029$export$2e2bcd8739ae039 = $349a00930b14e029$export$a97b6dfc795a2c05;
